...
tranverse = my_linked_list.get_head_node()

while tranverse.get_value()[0] != "Zachary":
	tranverse = tranverse.get_next_node()

linked_list_zachary_disease = tranverse.get_value()[1]
