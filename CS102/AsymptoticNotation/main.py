...
def find_max(linked_list):
  ...
  #Write Code Here
  result = linked_list.head_node.get_value()

  while linked_list.head_node.get_next_node():
    linked_list.head_node = linked_list.head_node.get_next_node() # iterate over the nodes
    if linked_list.head_node.get_value() >= result:
      result = linked_list.head_node.get_value()
  return result
