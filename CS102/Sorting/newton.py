...
def newton_sqrt(target_value, allowed_error):

    # at a starting point we assume that the sqrt has to be between 0 and the target value
...
print(newton_sqrt(25000, 0.0001))