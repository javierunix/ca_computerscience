...
# in daily_sales with some other character and save the result to daily_sales_replaced.

daily_sales_replaced = daily_sales.replace(";,;", ";")

# Split daily_sales_replaced around commas and save it to a new list daily_transactions.
daily_transactions = daily_sales_replaced.split(sep=",")

# Define an empty list daily_transactions_split
daily_transactions_split = []

# Iterate through daily_transactions. Append each of these split strings (which are lists now) to our new list
for daily_transaction in daily_transactions:
    daily_transactions_split.append(daily_transaction.split(sep=";"))

# Define an empty list transactions_clean.
transactions_clean = []

# Iterate through daily_transactions_split and for each transaction iterate 
...
for daily_transaction in daily_transactions_split: # iterate over the first list
    transactions_clean_sublist = [] # create a cleaned sublist to store the values of the first iteration
    for data_point in daily_transaction: # iterate over sublists
        data_point_striped = data_point.strip() # strip whitespaces
        transactions_clean_sublist.append(data_point_striped) # append the stripped data to the cleaned sublist
    transactions_clean.append(transactions_clean_sublist)
